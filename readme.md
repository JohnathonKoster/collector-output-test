> __NOTE:__ This repository is only a test for the https://github.com/JohnathonKoster/collector utility. Do not use the releases in this repository directly! Instead, use https://github.com/tightenco/collect.
